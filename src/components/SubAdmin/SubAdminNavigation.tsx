...
import { Sun, Moon, HelpCircle, User, LogOut, ChevronDown, Users, FileText } from 'lucide-react';
import { useAuth } from '../../hooks/useAuth';

interface SubAdminNavigationProps {
  currentUser?: {
    name: string;
    avatar?: string;
  };
...
const SubAdminNavigation: React.FC<SubAdminNavigationProps> = ({ 
  currentUser, 
  activeMode, 
  onModeChange 
}) => {
  ...
  const navItems = [
    ...
    { 
      ...
      href: '#team', 
      icon: Users,
      onClick: () => onModeChange('myTeam'),
      active: activeMode === 'myTeam'
    },
    { 
      name: 'My Processes', 
      href: '#processes', 
      icon: FileText,
      onClick: () => onModeChange('myProcesses'),
      active: activeMode === 'myProcesses'
    },
    { 
      name: 'Help', 
      href: '#help', 
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                  <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p className="text-xs text-blue-600 dark:text-blue-400 font-semibold">Sub-Administrator</p>
                  </div>
                  <button
                    onClick={() => {
